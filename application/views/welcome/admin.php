...
<section class="container">
	...
	<div class="row text-center">
		...
		<div class="col-xs-12 col-sm-2">
			...
			<a href="<?=base_url('page/index/'.$slides[1]->id)?>" class="btn btn-primary">進入管理</a>
		</div>
		<div class="col-xs-12 col-sm-2">
			...
			<a href="<?=base_url('page/index/'.$slides[2]->id)?>" class="btn btn-primary">進入管理</a>
		</div>
		<div class="col-xs-12 col-sm-2">
			...
			<a href="<?=base_url('page/index/'.$slides[3]->id)?>" class="btn btn-primary">進入管理</a>
		</div>
		<div class="col-xs-12 col-sm-2">
			...
			<a href="<?=base_url('page/index/'.$slides[4]->id)?>" class="btn btn-primary">進入管理</a>
		</div>
		<div class="col-xs-12 col-sm-2">
		...
		<div class="col-xs-12 col-sm-2">
			<img src="<?=base_url($slides[6]->path)?>" alt="" class="img-responsive">
			<p><?=$slides[6]->title?></p>
			<a href="<?=base_url('welcome/edit_slide/'.$slides[6]->id)?>" class="btn btn-warning">編輯</a>
		</div>
	</div>
	<div class="clearfix"></div>
	<hr>
